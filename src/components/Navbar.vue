 ...
 <nav class="navbar is-info" role="navigation" aria-label="main navigation">
   <div class="container">
    <div class="navbar-brand">
     <router-link :to="{ name: 'Home' }" class="navbar-item brand-text has-text-weight-bold">Dog Log!</router-link>
    ...
    <div id="navbarBasic" class="navbar-menu" :class="{ 'is-active': showNav }">
     <div class="navbar-end">
         <router-link :to="{ name: 'AllDogs' }" class="navbar-item">Dogs</router-link>
         <router-link :to="{ name: 'AddDog' }" class="navbar-item">Add Dog</router-link>
